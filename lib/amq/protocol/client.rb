...
# THIS IS AN AUTOGENERATED FILE, DO NOT MODIFY IT DIRECTLY!
#
# Instead, make changes to protocol.rb.pytemplate file
  ...
  module Protocol
    ...
    class Connection < Class
      ...
      class Start < Method
        ...
        def self.decode(data)
          offset = 0
          version_major = data[offset...(offset + 1)].unpack(PACK_CACHE[:c]).first
          offset += 1
          version_minor = data[offset...(offset + 1)].unpack(PACK_CACHE[:c]).first
          offset += 1
    ...
    class Queue < Class
      ...
      class DeclareOk < Method
        ...
        def self.decode(data)
          ...
          offset += length
          message_count = data[offset..(offset + 4)].unpack(PACK_CACHE[:N]).first
          offset += 4
          consumer_count = data[offset..(offset + 4)].unpack(PACK_CACHE[:N]).first
          offset += 4
      ...
      class Bind < Method
        ...
        # @return
        # [u"ticket = 0", u"queue = nil", u"exchange = nil", u"routing_key = EMPTY_STRING", u"nowait = false", u"arguments = {}"]
      ...
      class Purge < Method
        ...
        # @return
        # [u"ticket = 0", u"queue = nil", u"nowait = false"]
      ...
      class Delete < Method
        ...
        # @return
        # [u"ticket = 0", u"queue = nil", u"if_unused = false", u"if_empty = false", u"nowait = false"]
      ...
      class Unbind < Method
        ...
        # @return
        # [u"ticket = 0", u"queue = nil", u"exchange = nil", u"routing_key = EMPTY_STRING", u"arguments = {}"]
        def self.encode(channel, queue, exchange, routing_key, arguments)
          ticket = 0
          pieces = []
    ...
    class Basic < Class
      ...
      class Consume < Method
        ...
        # @return
        # [u"ticket = 0", u"queue = nil", u"consumer_tag = EMPTY_STRING", u"no_local = false", u"no_ack = false", u"exclusive = false", u"nowait = false", u"arguments = {}"]
      ...
      class Get < Method
        ...
        # @return
        # [u"ticket = 0", u"queue = nil", u"no_ack = false"]
