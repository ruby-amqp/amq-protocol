    ...
    class Connection < Protocol::Class
      ...
      class Start < Protocol::Method
        ...
        def self.decode(data)
          ...
          offset += 4
          mechanisms = data[offset..(offset + length - 1)]
          offset += length
          length = data[offset..(offset + 4)].unpack(PACK_CACHE[:N]).first
          offset += 4
          locales = data[offset..(offset + length - 1)]
          offset += length
      ...
      class Secure < Protocol::Method
        ...
        def self.decode(data)
          ...
          length = data[offset..(offset + 4)].unpack(PACK_CACHE[:N]).first
          offset += 4
          challenge = data[offset..(offset + length - 1)]
          offset += length
          self.new(challenge)
        end
      ...
      class OpenOk < Protocol::Method
        ...
        def self.decode(data)
          ...
          offset += 1
          known_hosts = data[offset..(offset + length - 1)]
          offset += length
    ...
    class Channel < Protocol::Class
      ...
      class OpenOk < Protocol::Method
        ...
        def self.decode(data)
          ...
          length = data[offset..(offset + 4)].unpack(PACK_CACHE[:N]).first
          offset += 4
          channel_id = data[offset..(offset + length - 1)]
          offset += length
          self.new(channel_id)
        end
    ...
    class Basic < Protocol::Class
      ...
      class GetEmpty < Protocol::Method
        ...
        def self.decode(data)
          ...
          length = data[offset..(offset + 1)].unpack(PACK_CACHE[:c])[0]
          offset += 1
          cluster_id = data[offset..(offset + length - 1)]
          offset += length
          self.new(cluster_id)
        end
